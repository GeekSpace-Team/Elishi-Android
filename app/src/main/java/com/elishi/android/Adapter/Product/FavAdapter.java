...
public class FavAdapter extends RecyclerView.Adapter<FavAdapter.ViewHolder> {
    private ArrayList<Favorites> products = new ArrayList<>();
    private Context context;
    private boolean isHorizontal = false;

    public FavAdapter(ArrayList<Favorites> products, Context context, boolean isHorizontal) {
    ...
    public void onBindViewHolder(@NonNull @NotNull FavAdapter.ViewHolder holder, int position) {
        Favorites product = products.get(holder.getAdapterPosition());
