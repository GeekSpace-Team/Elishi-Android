package com.elishi.android.DateBase;
...
public class SearchHistoryDB extends SQLiteOpenHelper {
    private static final String DBNAME="searchHistory";
    private static final String TBNAME="searchHistory";
    ...
    public Cursor getSelect(String queryText){
        SQLiteDatabase db=this.getWritableDatabase();
        Cursor cursor=db.rawQuery("SELECT * FROM "+TBNAME+" WHERE queryText = '"+queryText+"' ORDER BY ID DESC",null);
        return cursor;
    }
